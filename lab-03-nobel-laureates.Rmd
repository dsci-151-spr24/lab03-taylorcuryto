...
```
  There seems to be more people in the US than not in each category.
...
```
In general, this does support Buzzfeed's claim because most nobel prize winners live in the US, but they are born elsewhere; except for economics: more were born in the US.
